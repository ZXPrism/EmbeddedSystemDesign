...
proc create_root_design { parentCell } {
  ...
  set hdmi_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:hdmi_axi:1.0 hdmi_axi_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins hdmi_axi_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net hdmi_axi_0_hdmi_clk [get_bd_ports hdmi_clk] [get_bd_pins hdmi_axi_0/hdmi_clk]
  connect_bd_net -net hdmi_axi_0_hdmi_d [get_bd_ports hdmi_d] [get_bd_pins hdmi_axi_0/hdmi_d]
  connect_bd_net -net hdmi_axi_0_hdmi_de [get_bd_ports hdmi_de] [get_bd_pins hdmi_axi_0/hdmi_de]
  connect_bd_net -net hdmi_axi_0_hdmi_hsync [get_bd_ports hdmi_hsync] [get_bd_pins hdmi_axi_0/hdmi_hsync]
  connect_bd_net -net hdmi_axi_0_hdmi_scl [get_bd_ports hdmi_scl] [get_bd_pins hdmi_axi_0/hdmi_scl]
  connect_bd_net -net hdmi_axi_0_hdmi_sda [get_bd_ports hdmi_sda] [get_bd_pins hdmi_axi_0/hdmi_sda]
  connect_bd_net -net hdmi_axi_0_hdmi_vsync [get_bd_ports hdmi_vsync] [get_bd_pins hdmi_axi_0/hdmi_vsync]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins hdmi_axi_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins hdmi_axi_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hdmi_axi_0/S00_AXI/S00_AXI_reg] SEG_hdmi_axi_0_S00_AXI_reg
