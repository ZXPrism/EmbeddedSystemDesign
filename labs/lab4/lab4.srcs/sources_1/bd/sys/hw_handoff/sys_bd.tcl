...
proc create_root_design { parentCell } {
  ...
  set hdmi_d [ create_bd_port -dir O -from 15 -to 0 -type data hdmi_d ]
  set hdmi_de [ create_bd_port -dir O -type data hdmi_de ]
  set hdmi_hsync [ create_bd_port -dir O -type data hdmi_hsync ]
  set hdmi_scl [ create_bd_port -dir O -type clk hdmi_scl ]
  set hdmi_sda [ create_bd_port -dir O -type data hdmi_sda ]
  set hdmi_vsync [ create_bd_port -dir O -type data hdmi_vsync ]
  ...
  # Create instance: hdmi_axi_full_0, and set properties
  set hdmi_axi_full_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:hdmi_axi_full:1.0 hdmi_axi_full_0 ]
  ...
  connect_bd_intf_net -intf_net hdmi_axi_full_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins hdmi_axi_full_0/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net hdmi_axi_full_0_hdmi_clk [get_bd_ports hdmi_clk] [get_bd_pins hdmi_axi_full_0/hdmi_clk]
  connect_bd_net -net hdmi_axi_full_0_hdmi_d [get_bd_ports hdmi_d] [get_bd_pins hdmi_axi_full_0/hdmi_d]
  connect_bd_net -net hdmi_axi_full_0_hdmi_de [get_bd_ports hdmi_de] [get_bd_pins hdmi_axi_full_0/hdmi_de]
  connect_bd_net -net hdmi_axi_full_0_hdmi_hsync [get_bd_ports hdmi_hsync] [get_bd_pins hdmi_axi_full_0/hdmi_hsync]
  connect_bd_net -net hdmi_axi_full_0_hdmi_scl [get_bd_ports hdmi_scl] [get_bd_pins hdmi_axi_full_0/hdmi_scl]
  connect_bd_net -net hdmi_axi_full_0_hdmi_sda [get_bd_ports hdmi_sda] [get_bd_pins hdmi_axi_full_0/hdmi_sda]
  connect_bd_net -net hdmi_axi_full_0_hdmi_vsync [get_bd_ports hdmi_vsync] [get_bd_pins hdmi_axi_full_0/hdmi_vsync]
  connect_bd_net -net hdmi_axi_full_0_txn_request [get_bd_pins hdmi_axi_full_0/m00_axi_init_axi_txn] [get_bd_pins hdmi_axi_full_0/txn_request]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins hdmi_axi_full_0/m00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins hdmi_axi_full_0/m00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hdmi_axi_full_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
